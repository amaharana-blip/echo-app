...
import { AI_TOOLS_MODULE, type ModuleInsights } from "@/lib/modules";
...
export default function AIToolsPage() {
  ...
  async function handleComplete(
    ...
    try {
      ...
      router.push("/dashboard?success=ai-tools");
    } catch {
      setPosting(false);
    }
  }
    ...
    <div className="min-h-screen bg-[#F8F9FC]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <main className="ml-0 md:ml-60">
        {posting ? (
          ...
          <ModuleSurveyEngine module={AI_TOOLS_MODULE} onComplete={handleComplete} />
        )}
      </main>
    </div>
  );
